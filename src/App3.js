...
class App extends Component {
  ...
  render() {
    let headerTitleStyle ={display:'inline',position:"relative",left:40}
    return (
        ...
        <Layout>
          <Header style={{ background: '#fff', padding: 0 }}>
            ...
            <Menu mode="horizontal"
                  style={{ lineHeight: '64px', float: 'right' ,display:'inline_block'}}
                 >
                ...
                <Menu.Item style ={{position:'relative',right:50}} key="buttonDatabase">
                    <Button type="primary" ghost>链接数据库</Button>
                </Menu.Item> 
            </Menu>
          </Header>
